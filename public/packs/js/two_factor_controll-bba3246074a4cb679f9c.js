...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/two_factor_controll.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/two_factor_controll.js":
/*!*****************************************************!*\
  !*** ./app/javascript/packs/two_factor_controll.js ***!
  \*****************************************************/
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  console.log('#customSwitch1');
  $(".custom-control-label").click(function () {
    if (this.value == "inactive") {
      alert("We recommend to keep two factor active!" + this.value);
      $("#save_detailes").trigger('click');
      window.location.reload(true);
    } else {
      alert("You will get a one time code in your email each time you trying to login");
      $("#save_detailes").trigger('click');
      window.location.reload(true);
    }
  });
...
/******/ });
//# sourceMappingURL=two_factor_controll-bba3246074a4cb679f9c.js.map