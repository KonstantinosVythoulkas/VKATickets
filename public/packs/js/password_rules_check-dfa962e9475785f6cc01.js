...
$('#new_password, #password_comf').on('keyup', function () {
  ...
  if ($('#new_password').val() == $('#password_comf').val() && $('#new_password').val().length >= 8) {
...
/******/ });
//# sourceMappingURL=password_rules_check-dfa962e9475785f6cc01.js.map