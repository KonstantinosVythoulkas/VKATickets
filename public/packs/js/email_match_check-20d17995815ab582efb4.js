...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/email_match_check.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/email_match_check.js":
/*!***************************************************!*\
  !*** ./app/javascript/packs/email_match_check.js ***!
  \***************************************************/
...
$('#new_email_conf, #new_email').on('keyup', function () {
  if ($("#new_email").val() != $("#new_email_conf").val()) {
    ...
    $('#new_email').attr('style', 'border:4px solid #ed1000');
    $('#new_email_conf').attr('style', 'border:4px solid #ed1000');
  } else if (email_regex.test($("#new_email").val() && email_regex.test($("#new_email_conf").val()))) {
...
/******/ });
//# sourceMappingURL=email_match_check-20d17995815ab582efb4.js.map