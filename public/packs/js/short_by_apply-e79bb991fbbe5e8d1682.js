...
/* WEBPACK VAR INJECTION */(function($) {$('.sbutton').hide();
$('#singleSelectValueDDJS').click;
console.log($('#singleSelectValueDDJS').val());
$(document).on('change', '#singleSelectValueDDJS', function () {
...
/******/ });
//# sourceMappingURL=short_by_apply-e79bb991fbbe5e8d1682.js.map